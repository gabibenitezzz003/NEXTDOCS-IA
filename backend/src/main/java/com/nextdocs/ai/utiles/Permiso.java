...
public final class Permiso {
	...
	public static final String CANALES_LEER = "canales.leer";

	public static final String CANALES_ADMINISTRAR = "canales.administrar";
	...
	public static Set<String> todos() {
		return new LinkedHashSet<>(List.of(DOCUMENTOS_LEER, DOCUMENTOS_ESCRIBIR, DOCUMENTOS_REVISAR,
				...
				EXCEPCIONES_GESTIONAR, GOBERNANZA_LEER, GOBERNANZA_ADMINISTRAR, TENANT_ADMINISTRAR, CANALES_LEER,
				CANALES_ADMINISTRAR));
	}

	public static Set<String> deOperador() {
		return new LinkedHashSet<>(
				List.of(DOCUMENTOS_LEER, DOCUMENTOS_ESCRIBIR, PLANTILLAS_LEER, EXCEPCIONES_LEER, CANALES_LEER));
	}
	...
	public static Set<String> deRevisor() {
		return new LinkedHashSet<>(List.of(DOCUMENTOS_LEER, DOCUMENTOS_ESCRIBIR, DOCUMENTOS_REVISAR, PLANTILLAS_LEER,
				EXCEPCIONES_LEER, EXCEPCIONES_GESTIONAR, CANALES_LEER));
	}

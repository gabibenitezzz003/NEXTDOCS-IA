export const es = {
  ...
  canvas: {
    ...
    integracionLista:
      "Este paso usa la integración {nombre} configurada en Integraciones.",
    integracionPropia:
      "Este paso usa sus propias credenciales, no la integración de la organización.",
    integracionFalta:
      "Este paso necesita credenciales: cargá la integración del servicio para que pueda ejecutarse.",
    integracionFaltaEnlace: "Abrir Integraciones",
  ...
  integraciones: {
    ...
    descripcion:
      "Conectá los servicios que usan los pasos de tus procesos: correo SMTP, Telegram y WhatsApp. Las credenciales se guardan cifradas y solo las usa tu organización.",
    ayuda:
      "Los pasos de tipo Correo, Telegram y WhatsApp usan estas credenciales al ejecutarse. Si un paso define sus propios datos, esos tienen prioridad. Probá cada integración antes de publicar el proceso.",
    nombre: {
      CORREO: "Correo (SMTP)",
      SMTP: "Otro correo (SMTP)",
      TELEGRAM: "Telegram",
    ...
    catalogo: {
      ...
      slack: {
        nombre: "Slack",
        detalle: "Mensajes a los canales de tu equipo",
      },
      googledrive: {
        nombre: "Google Drive",
        detalle: "Guardar y leer archivos en la nube",
      },
    },
    oauth: {
      conectar: {
        google: "Conectar con Google",
        microsoft: "Conectar con Microsoft",
      },
      conectada: "{nombre} quedó conectada. Ya podés usarla en tus procesos.",
      conectadaComo: "Conectada como {cuenta}",
      desconectar: "Desconectar",
      desconectarTitulo: "Desconectar cuenta",
      desconectarConfirmar:
        "Se desconecta la cuenta {cuenta}. Los pasos de correo van a fallar hasta que conectes otra cuenta o cargues SMTP.",
      noDisponible:
        "La conexión automática todavía no está habilitada en esta instalación.",
      otraActiva:
        "El correo ya está configurado por otro método; conectar esta cuenta lo reemplaza.",
    },
    guia: {
      telegram: {
        "1": "Abrí Telegram y buscá @BotFather",
        "2": "Enviá /newbot, elegí nombre y usuario; te devuelve un token",
        "3": "Pegá el token acá abajo y tocá Guardar y Probar conexión",
      },
      whatsapp: {
        "1": "En developers.facebook.com creá una app con el producto WhatsApp",
        "2": "En la configuración de la API copiá el token permanente y el ID del número",
        "3": "Pegalos acá abajo y tocá Guardar y Probar conexión",
      },
    },
    smtpReemplaza:
      "El correo sale actualmente por la cuenta {cuenta}. Guardar este formulario la reemplaza.",
    proximamente: "Próximamente",
    detalle: {
      CORREO: "Envío manual por servidor SMTP (avanzado)",
      TELEGRAM: "Bot de Telegram para mensajes automáticos",
      WHATSAPP: "Línea de WhatsApp Business (Meta)",
    },
    campo: {
      host: "Servidor SMTP",
      puerto: "Puerto",
      usuario: "Usuario",
      clave: "Contraseña",
      remitente: "Remitente (opcional)",
      seguridad: "Seguridad",
      tokenBot: "Token del bot",
      tokenAcceso: "Token de acceso",
      telefonoId: "ID del número de teléfono",
      apiVersion: "Versión de la API (opcional)",
    },
    ninguna: "Ninguna",
    habilitada: "Integración habilitada",
    secretoGuardado: "Ya hay un valor guardado; dejalo vacío para conservarlo.",
    probar: "Probar conexión",
    destinoPrueba: "Enviar correo de prueba a (opcional)",
    destinoPruebaAyuda:
      "Si indicás un correo, la prueba envía un mensaje real además de verificar la conexión.",
    guardada: "Integración guardada.",
    eliminada: "Integración eliminada.",
    sinConfigurar: "Sin configurar",
    configurada: "Configurada",
    deshabilitada: "Deshabilitada",
    verificada: "Verificada",
    eliminar: "Quitar",
    eliminarTitulo: "Quitar integración",
    eliminarConfirmar:
      "Se elimina la configuración de {nombre}. Los pasos que la usen van a fallar hasta que la vuelvas a cargar.",
    errorCarga: "No se pudieron cargar las integraciones",
  },
};

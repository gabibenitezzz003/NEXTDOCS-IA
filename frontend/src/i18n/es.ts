export const es = {
  ...
  documental: {
    ...
    plantillas: {
      bajada:
        "Las plantillas publicadas deciden la clasificación, los campos y las reglas de cada documento.",
      vacio: "Sin plantillas",
      vacioDetalle:
        "Instalá una plantilla del catálogo para empezar a clasificar.",
      catalogo: "Catálogo disponible",
      instalar: "Instalar",
      instalada: "Plantilla instalada.",
      guardar: "Guardar ajustes",
      descartar: "Descartar",
      deprecar: "Deprecar",
      republicar: "Republicar",
      guardada: "Plantilla guardada.",
      estadoCambiado: "Estado de la plantilla actualizado.",
      aprobaSolo: "Aprueba sola desde",
      umbralAyuda:
        "Umbral de confianza global para aprobación automática. Por debajo, el documento pasa a revisión humana.",

...
export const en: Diccionario = {
  ...
  documental: {
    ...
    plantillas: {
      bajada:
        "Published templates drive the classification, fields and rules of each document.",
      vacio: "No templates",
      vacioDetalle: "Install a template from the catalog to start classifying.",
      catalogo: "Available catalog",
      instalar: "Install",
      instalada: "Template installed.",
      guardar: "Save settings",
      descartar: "Discard",
      deprecar: "Deprecate",
      republicar: "Republish",
      guardada: "Template saved.",
      estadoCambiado: "Template state updated.",
      aprobaSolo: "Auto-approves from",
      umbralAyuda:
        "Global confidence threshold for automatic approval. Below it, the document goes to human review.",
      avisoVencimiento: "Days of notice before expiration",
      avisoAyuda:
        "How many days before expiration a document is marked as expiring.",
      campos: "Fields",
      umbralCampo: "Threshold %",
      requerido: "Required",
      critico: "Critical",
    },
    tablero: {

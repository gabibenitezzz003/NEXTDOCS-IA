...
export const en: Diccionario = {
  ...
  procesos: {
    ...
    ejecucionPorNodo: "Step-by-step run",
    ejecucionDetalle: "View details",
    datosPruebaTitulo: "Input data (optional)",
    datosPrueba: "Input data (JSON)",
    datosPruebaAyuda:
      "If the flow reads variables like {{datos.field}}, load them here as a JSON object.",
    datosPruebaInvalidos: "Input data must be a valid JSON object.",
    ejecucionInstancia: "Instance",
    ejecucionExito: "Run completed successfully",
    ejecucionResumen: "Finished {fin} · took {duracion}",
    ejecucionError: "The run stopped with an error",

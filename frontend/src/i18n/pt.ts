...
export const pt: Diccionario = {
  ...
  documental: {
    ...
    plantillas: {
      bajada:
        "Os modelos publicados decidem a classificação, os campos e as regras de cada documento.",
      vacio: "Sem modelos",
      vacioDetalle: "Instale um modelo do catálogo para começar a classificar.",
      catalogo: "Catálogo disponível",
      instalar: "Instalar",
      instalada: "Modelo instalado.",
      guardar: "Salvar ajustes",
      descartar: "Descartar",
      deprecar: "Descontinuar",
      republicar: "Republicar",
      guardada: "Modelo salvo.",
      estadoCambiado: "Estado do modelo atualizado.",
      aprobaSolo: "Aprova sozinho a partir de",
      umbralAyuda:
        "Limiar de confiança global para aprovação automática. Abaixo dele, o documento vai para revisão humana.",

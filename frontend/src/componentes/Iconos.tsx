...
export function IconoGmail({ tamano = 18, ...resto }: PropsIcono) {
  return (
    <svg
      width={tamano}
      height={tamano}
    ...
    >
      <path
        fill="#4285F4"
        d="M2.5 5.5v13a2 2 0 0 0 2 2h1.5V9.4l6 4.5 6-4.5v11.1h1.5a2 2 0 0 0 2-2v-13z"
      />
      <path fill="#34A853" d="M21.5 5.5 18 9.4v11.1h1.5a2 2 0 0 0 2-2v-13z" />
      <path fill="#FBBC04" d="M21.5 5.5 18 9.4l3.5-2.6z" />
      <path fill="#EA4335" d="M2.5 5.5 12 12.7l9.5-7.2-3.5-2.6-6 4.5-6-4.5z" />
      <path fill="#C5221F" d="M2.5 5.5 6 9.4V20.5H4.5a2 2 0 0 1-2-2v-13z" />
    </svg>
  );
}

export function IconoTelegram({ tamano = 18, ...resto }: PropsIcono) {
  return (
    <svg
      width={tamano}
      height={tamano}
    ...
    >
      ...
      <path
        fill="#FFFFFF"
        d="m17.3 7.2-2.6 11c-.2.87-.72 1.09-1.46.68l-4.03-2.97-1.95 1.88c-.22.21-.4.4-.81.4l.29-4.09 7.44-6.72c.32-.29-.07-.45-.5-.16l-9.2 5.79-3.96-1.24c-.86-.27-.88-.86.18-1.28l15.45-5.96c.72-.26 1.35.18 1.21 1.27z"
      />
    </svg>
  );
}

export function IconoWhatsapp({ tamano = 18, ...resto }: PropsIcono) {
  return (
    <svg
      width={tamano}
      height={tamano}
    ...
    >
      <path
        fill="#25D366"
        d="M12.04 2a9.9 9.9 0 0 0-8.44 15.08L2 22l5.05-1.32A9.9 9.9 0 1 0 12.04 2z"
      />
      <path
        fill="#FFFFFF"
        d="M17.51 14.38c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.25-.46-2.39-1.47-.88-.79-1.48-1.76-1.65-2.06-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.49 0 1.47 1.07 2.89 1.22 3.09.15.2 2.1 3.2 5.08 4.49.71.3 1.26.49 1.7.62.71.23 1.36.2 1.87.12.57-.08 1.76-.72 2-1.41.25-.7.25-1.29.18-1.42-.08-.12-.28-.2-.57-.35z"
      />
    </svg>
  );
}

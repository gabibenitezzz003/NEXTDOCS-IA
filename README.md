...
| **Multi-idioma (es/en/pt)** | ✅ Implementado | Portal y errores del backend traducidos; selector con persistencia en el perfil y `Accept-Language` en cada request; detalle en `docs/I18N.md` |
